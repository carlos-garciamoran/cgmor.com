...
export default function Home() {
  ...
  return (
    <div className="flex flex-col flex-grow mt-8 sm:mt-0 mx-8 sm:mx-0 sm:justify-center">
      ...
      <div className="animate-mutate border-4 border-cyan-500 mt-8 sm:mt-12 p-3 sm:p-5 xl:p-8 mx-auto">
