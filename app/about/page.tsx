...
export default function Page() {
  return (
    <div className="mx-auto flex w-full max-w-screen-sm flex-col items-center justify-center gap-y-4 text-justify">
      <p>
        ...
        to satisfy my curiosity. OverTheWire, CTFs, and writing Python became my
        go-to hobbies during late nights. I started using Linux and getting
      ...
      <p>
        ...
        Seeing how time-consuming and frustrating many of my school's processes
        were, I built{' '}
      ...
      <p>
        During fall 2022, I traveled to 11 countries through the Semester at Sea
        study abroad program. Throughout the voyage, I learned how to develop
        mobile applications using React Native and TypeScript. To put it into
        practice, I built the{' '}
        <ExternalLink
